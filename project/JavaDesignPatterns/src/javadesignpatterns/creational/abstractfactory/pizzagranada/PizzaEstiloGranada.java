 ...
 */
package javadesignpatterns.creational.abstractfactory.pizzagranada;
 ...
 * @version 1.0
 */
public class PizzaEstiloGranada extends AbstractFactoryPizza {

    @Override
    public void preparar() {
        Logger.getLogger(PizzaEstiloManagua.class.getSimpleName()).log(Level.INFO,
                "Pizza prepara el artesano Estilo GRANADA.");
    }
